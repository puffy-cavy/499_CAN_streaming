...
def can_capnp_to_can_list(can, src_filter=None):
  ...
  for msg in can:
    if src_filter is None or msg.src in src_filter:
      ...
      #WENDY-TODO:print("WENDY msg.dat:", msg.dat.decode('utf-8','ignore'))
  return ret
...
def boardd_mock_loop():
  ...
  while 1:
    ...
    if counter_wendy > start_wendy - 200 and counter_wendy <= start_wendy:
       pre_wendy.append(snd)
    if counter_wendy > start_wendy:
       left = (counter_wendy- start_wendy ) % 200
       snd = pre_wendy[left]
       print("ENTER ROLL BACK")

    can_send_many(snd)
    counter_wendy = counter_wendy+1
